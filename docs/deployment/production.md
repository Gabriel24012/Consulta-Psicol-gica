...
- Configurar `NODE_ENV=production`, `WEB_PUBLIC_URL` con el dominio real, `COOKIE_SECURE=true`, `LETSENCRYPT_HOST_PATH` con la ruta local de certificados y `COOKIE_DOMAIN` solo si se usan subdominios compartidos.
